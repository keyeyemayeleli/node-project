...
function requireResolve(builder, path) {
    var requireResolveNode = builder.memberExpression(builder.identifier("require"), builder.identifier("resolve"));
    ...
    helper(name) {
        ...
        if (!helperIdentifier) {
            ...
            if (typeof helperInfo === "string") {
                ...
                helperIdentifier = this.addStaticVar("marko_" + name, this.builder.memberExpression(this.helpersIdentifier, methodIdentifier));
                ...
                if (helperInfo.method) {
                    ...
                    helperIdentifier = this.addStaticVar("marko_" + name, this.builder.memberExpression(moduleIdentifier, helperInfo.method));
                } else {
