            ...
            case "IfStatement":
                {
                    ...
                    do {
                        if (alternate.consequent) {
                            ...
                            container.appendChild(builder.elseIfStatement(elseIfNodeTest, elseIfNodeBody));
                        } else {
                            ...
                            container.appendChild(builder.elseStatement(elseNodeBody));
                        }
            ...
            case "ForStatement":
                {
                    ...
                    if (!forNodeInit || !forNodeTest || !forNodeUpdate || !forNodeBody) {
                        return null;
                    }

                    return builder.forStatement(forNodeInit, forNodeTest, forNodeUpdate, forNodeBody);
                }
            case "WhileStatement":
                {
