...
function parse(templateSrc, filename, options) {
    ...
    if (context.hasErrors()) {
        ...
        var message = 'An error occurred while trying to parse template at path "' + filename + '". Error(s) in template:\n';
...
function registerCoreTaglibs() {
    if (!coreTaglibsRegistered) {
        ...
        registerTaglib(require("../taglibs/migrate/marko.json"), require.resolve("../taglibs/migrate/marko.json"));
