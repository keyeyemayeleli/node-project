...
function AsyncStream(global, writer, parentOut, shouldBuffer) {
    ...
    this._r_ = null; // ComponentsContext
 ...
 */
AsyncStream.INCLUDE_STACK = typeof process !== "undefined" && (!process.env.NODE_ENV || process.env.NODE_ENV === "development" || process.env.NODE_ENV === "dev");
...
var proto = AsyncStream.prototype = {
    ...
    _doFinish: function () {
        ...
        if (state.writer.end) {
            ...
            state.events.emit("finish", this.aT_());
        }
    },
...
// alias:
proto.w = proto.write;
proto.aP_ = proto.element;
proto.aN_ = proto.beginElement;
proto.aO_ = proto.endElement;
