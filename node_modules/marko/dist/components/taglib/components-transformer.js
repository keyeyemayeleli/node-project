...
module.exports = function transform(el, context) {
    ...
    if (el.type === "TemplateRoot") {
        ...
        if (!context.isFlagSet("hasLegacyWidgetBind") && context.isFlagSet("hasLegacyWidgetAttr")) {
    ...
    if (el.hasAttribute("w-body")) {
        ...
        if (!bodyValue) {
            bodyValue = builder.memberExpression(builder.identifier("__component"), builder.identifier("b"));
