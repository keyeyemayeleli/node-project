...
module.exports = function handleLegacyBind() {
    ...
    if (bindAttrValue != null && !bindAttr.isLiteralValue()) {
        ...
        el.insertSiblingBefore(builder.functionCall(builder.memberExpression(builder.identifier("__component"), builder.identifier("t")), [builder.memberExpression(builder.identifier("marko_componentTypes"), bindAttrValue, true /* computed */
        )]));
    }
    ...
    if (el.hasAttribute("w-config")) {
        el.insertSiblingBefore(builder.functionCall(builder.memberExpression(builder.identifier("__component"), builder.identifier("c")), [el.getAttributeValue("w-config")]));
