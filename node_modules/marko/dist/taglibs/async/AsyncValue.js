...
AsyncValue.prototype = {
     ...
     * available.
     */
    bN_: function (callback) {
        // Do we already have data or error?
        if (this.bM_) {
            // invoke the callback immediately
            return callback(this.bK_, this.aJ_);
        }

        var callbacks = this.bL_ || (this.bL_ = []);
    ...
    bP_: function (value) {
        ...
        if (value && typeof value.then === "function") {
            ...
            var finalPromise = value.then(function onFulfilled(value) {
                nextTick(asyncValue.bP_.bind(asyncValue, value));
            }, function onRejected(err) {
                nextTick(asyncValue.bO_.bind(asyncValue, err));
            });
