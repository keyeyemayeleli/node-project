...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        provider.call(thisObj, callback) : // two arguments so provide args and callback to function call
        provider.call(thisObj, args, callback);

        if (value !== undefined) {
            asyncValue.bP_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bP_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bO_(error);
        }, timeout);

        asyncValue.bN_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bQ_ || (out.global.bQ_ = {
            instances: [],
            nextId: 0
        });
