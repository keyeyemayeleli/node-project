...
module.exports = function migrate(el, context) {
    ...
    if (value == null) {
        ...
        if (!componentModule) {
            context.addError('No corresponding JavaScript module found in the same directory (either "widget.js", "component.js" or "index.js").');
            return;
        }
        ...
        if (typeof literalValue !== "string") {
            context.addError('The value for the "w-bind" attribute should be a string. Actual: ' + literalValue);
            return;
        }
        ...
        if (!filename) {
            this.addError("Target file not found: " + literalValue + " (from: " + context.dirname + ")");
            return;
        }
    ...
    context.addMigration({
        ...
        apply(helpers) {
            ...
            return helpers.prompt({
                type: "confirm",
                message: "A widget file was discovered, would you like to migrate that as well?\n" + "Note: widget migrations are not 100% safe and should be tested after migration.",
                initial: true
            }).then(shouldMigrate => {
                if (shouldMigrate) {
